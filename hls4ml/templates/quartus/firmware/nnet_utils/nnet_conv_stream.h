...
* This function works for both 1D and 2D, since CONFIG_T::filt_height = 1 for Conv1D and will not be synthesized as a loop during HLS synthesis
*/
...
* This function works for both 1D and 2D, since CONFIG_T::filt_height = 1 for Conv1D and will not be executed at all
*/
template <class data_T, typename CONFIG_T>
