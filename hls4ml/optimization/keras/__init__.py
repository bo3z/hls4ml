...
def optimize_model(
    ...
    if not isinstance(optimizer, (tf.keras.optimizers.Optimizer, keras.optimizers.Optimizer)):
    ...
    if not isinstance(loss_fn, (tf.keras.losses.Loss, keras.losses.Loss)):
    ...
    if not isinstance(validation_metric, (tf.keras.metrics.Metric, keras.metrics.Metric)):
