...
def keras_model(mnist_data):
  ...
  keras_model.add(Conv2D(4, (3,3), input_shape=(28, 28, 1), kernel_initializer='lecun_uniform', padding='same'))
  keras_model.add(Activation('relu'))
  keras_model.add(MaxPooling2D())
  keras_model.add(Conv2D(6, (5,5), kernel_initializer='lecun_uniform', padding='valid'))
  keras_model.add(Activation('relu'))
